          ...
          <div <?php post_class( 'property-box-2 wow fadeInUp delay-03s' ); ?> id="post-<?php the_ID(); ?>">
            <div class="row">
              <div class="col-lg-5 col-md-5 col-pad">
                <a href="properties-details.html" class="property-img"> <?php echo PG_Image::getPostImage( null, 'imovel', array(
                      'class' => 'img-fluid',
              ...
              <div class="col-lg-7 col-md-7">
                ...
                <a href="<?php echo esc_url( get_permalink() ); ?>" class="btn button-theme"><?php _e( 'Detalhes', 'pam' ); ?></a>
                <div class="footer">
