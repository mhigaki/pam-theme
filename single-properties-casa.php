                            ...
                            <div class="col-md-6"> 
                                <div class="breadcrumb-area"> 
                                    ...
                                    <?php if( !empty( $breadcrumbs ) ) : ?>
                                        <ul cms-breadcrumbs-first-item-name="a" cms-breadcrumbs-last-item="> li:nth-of-type(2) > span:nth-of-type(2)" cms-breadcrumbs-last-item-name="> li:nth-of-type(2) > span:nth-of-type(2)" cms-breadcrumbs-separator="> li:nth-of-type(2) > span:nth-of-type(1)" cms-breadcrumbs-item-name="a" cms-breadcrumbs-home> 
                                            <li>
                            ...
                            <div class="properties-details-section"> 
                                ...
                                <div class="tabbing tabbing-box mb-40"> 
                                    <ul class="nav nav-tabs" id="carTab" role="tablist"> 
                                        <li class="nav-item"> <a class="active nav-link show" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="three" aria-selected="true"><?php _e( 'Detalhes', 'pam' ); ?></a> 
                                        </li>                                         
                                        <li class="nav-item"> <a class="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="two" aria-selected="false"><?php _e( 'Planta', 'pam' ); ?></a> 
                                        </li>                                         
                                                ...
                                                <div class="row"> 
                                                    <div class="col-md-4 col-sm-6"> 
                                                        <ul> 
                                                            ...
                                                            <li> <strong><?php _e( 'Property Type:', 'pam' ); ?></strong>
                                                    ...
                                                    <div class="col-md-4 col-sm-6"> 
                                                        <ul> 
                                                            ...
                                                            <?php endif; ?> 
                                                            <li> <strong><?php _e( 'Área Construída:', 'pam' ); ?></strong>
                                                                <?php _e( '230 ft2', 'pam' ); ?> 
                                                            </li>                                                             
                                                            <li> <strong><?php _e( 'Construído em:', 'pam' ); ?></strong>
                                                                <?php _e( '2018', 'pam' ); ?> 
                                                            </li>                                                             
                                                            <li> <strong><?php _e( 'Available From:', 'pam' ); ?></strong>
                                                                <?php _e( '2018', 'pam' ); ?> 
                                                            </li>                                                             
                                                    ...
                                                    <div class="col-md-4 col-sm-6"> 
                                                        <ul> 
                                                            <li> <strong><?php _e( 'Sold:', 'pam' ); ?></strong>
                                                                <?php _e( 'Yes', 'pam' ); ?> 
                                                            </li>                                                             
                                                            ...
                                                            <?php endif; ?> 
                                                            <li> <strong><?php _e( 'Parking:', 'pam' ); ?></strong>
                                                                <?php _e( 'Yes', 'pam' ); ?> 
                                                            </li>                                                             
                                                            <li> <strong><?php _e( 'Property Owner:', 'pam' ); ?></strong>
                                                                <?php _e( 'Sohel Rana', 'pam' ); ?> 
                                                            </li>                                                             
                                                            <?php if ( get_field( 'cep' ) ) : ?>
                                                                <li> <strong><?php _e( 'CEP:', 'pam' ); ?> </strong>
