                ...
                <div class="col-md-6"> 
                    <div class="breadcrumb-area"> 
                        ...
                        <?php if( !empty( $breadcrumbs ) ) : ?>
                            <ul cms-breadcrumbs-home-name="<i class=&quot;fa  fa-home&quot;></i> Home" cms-breadcrumbs-separator="span" cms-breadcrumbs-first-item-name="> li:nth-of-type(2)" cms-breadcrumbs-last-item-name="> li:nth-of-type(2)" cms-breadcrumbs-home cms-breadcrumbs-item-name="a" cms-breadcrumbs-last-item="> li:nth-of-type(2)"> 
                                <li>
