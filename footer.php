        ...
        <?php if ( ! is_404() ) : ?>
            <footer class="footer site-footer">
                <div class="container footer-inner">
                        ...
                        <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                            <div class="footer-item">
                                ...
                                <ul class="clearfix social-list"> 
                                    <li><a class="facebook" rel="nofollow noreferrer noopener" target="_blank"><i class="fa fa-facebook"></i></a>
                                    </li>                                     
                                    <li><a href="#" class="twitter" rel="nofollow noreferrer noopener" target="_blank"><i class="fa fa-twitter"></i></a>
                                    </li>                                     
                                    <li><a href="#" class="linkedin" rel="nofollow noreferrer noopener" target="_blank"><i class="fa fa-linkedin"></i> </a>
                                    </li>                                     
                                    <li><a href="#" class="rss" rel="nofollow noreferrer noopener" target="_blank"><i class="fa fa-instagram"></i></a>
                                    </li>                                     
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="clearfix footer-item" id="subscribe_mailer_id">
                                ...
                                <div class="Subscribe-box">
                                    ...
                                    <?php if( !$mailer->processed || $mailer->error) : ?>
                                        <form action="<?php echo '#subscribe_mailer_id'; ?>" method="post" id="subscribe" onsubmit="event.stopImmediatePropagation();event.stopPropagation();">
                                            ...
                                            <p> <button class="btn btn-block button-theme" type="submit">
                                                    <?php _e( 'Quero Receber', 'pam' ); ?>
                                                </button> </p>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <p class="copy"><?php _e( '© 2021', 'pam' ); ?> <a href="#" rel="home"><?php bloginfo( 'name' ); ?></a> <?php _e( 'Todos os Direitos Reservados | Política de Privacidade.', 'pam' ); ?></p>
                        </div>
                    </div>
                </div>
            </footer>
